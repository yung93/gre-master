    ...
    <div className="page-shell pt-12 pb-20">
      <header className="max-w-3xl">
        ...
        <p className="mt-5 text-[var(--color-ink-muted)] leading-relaxed">
          Pick a pillar and start a session. Progress is kept locally per browser, so the
          same device remembers what you have already mastered and what is about to slip.
        </p>
      </header>
